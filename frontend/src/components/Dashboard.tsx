...
export default function Dashboard({ gameState, onSelectCountry, onOpenHistory }: Props) {
  ...
  return (
    <div className="dashboard">
      ...
      <div className="controls-bar">
        ...
        <button className="btn btn-sm btn-accent" onClick={onOpenHistory}>HISTORY</button>
        <button className="btn btn-success create-country-btn" onClick={() => window.dispatchEvent(new CustomEvent('open-create-country'))}>+ CREATE COUNTRY</button>
      </div>
